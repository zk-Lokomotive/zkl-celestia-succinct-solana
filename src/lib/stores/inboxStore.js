        ...
        for (const tx of userTransactions) {
          try {
            ...
            const message = {
              ...
              celestiaNamespace: tx.namespace,
              celestiaUrl: `https://explorer.consensus-celestia.app/block/${celestiaHeight}/namespace/${(tx.namespace || "0x7a6b6c2d69706673").replace('0x', '')}`,
